...
class Default_Model_Businessunits extends Zend_Db_Table_Abstract
{
	...
	public function getBusinessUnitsData($sort, $by, $pageNo, $perPage,$searchQuery)
	{
		...
		$businessunitsdata = $this->select()
						   ...
						   ->from(array('b' => 'main_businessunits'),array('id'=>'distinct(b.id)','isactive'=>'b.isactive','unitcode'=>'b.unitcode','address1'=>'b.address1','unitname'=>'b.unitname','unithead'=>'b.unithead','startdate'=>'DATE_FORMAT(b.startdate,"'.DATEFORMAT_MYSQL.'")', 'modifieddate' => 'b.modifieddate'))
